...
# Copy it locally before running the sign command above.`;
                    ...
                    <div className="flex items-start gap-3 flex-1">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-zinc-400 mt-1">
                                A demo Ed25519 keypair ships with the orchestrator so you can run your first job without setup.
...
print(f"Running on {'{'}platform.node(){'}'} ({'{'}platform.system(){'}'})") `}</pre>
                        ...
                        <div>
                            <p className="text-xs font-bold uppercase tracking-widest text-zinc-400 mb-2">Step 2 — Copy the demo private key</p>
                            <div className="relative">
                        ...
                        <div className="rounded-lg border border-red-500/20 bg-red-500/5 p-3">
                            <p className="text-xs text-red-400">
                                <strong>Production warning:</strong> The demo key private file is committed to the repo and is not secret. Replace it with a key you generated yourself before handling any real workloads.
                            </p>
                        </div>
                    </div>
                    <DialogFooter>
