...
class TestCreateJobCountersign:
    ...
    @pytest.mark.anyio
    async def test_create_job_calls_countersign(self, async_client, auth_headers, temp_signing_key):
        """
    ...
    @pytest.mark.anyio
    async def test_create_job_500_on_missing_key(self, async_client, auth_headers):
        """
