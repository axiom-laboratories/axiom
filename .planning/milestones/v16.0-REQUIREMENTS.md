# Requirements Archive: v16.0 Competitive Observability
...
- [x] **VALD-03**: Validation failures are visible in execution history and the job detail view
