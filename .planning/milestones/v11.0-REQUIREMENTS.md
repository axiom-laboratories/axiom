# Requirements Archive: v11.0 CE/EE Split Completion
...
- [ ] **DIST-02**: `axiom-ce` image published to Docker Hub in existing `release.yml` — two-step addition alongside GHCR *(deferred from Phase 37 — GHCR covers current deployment scenarios; schedule for v12.0+)*
