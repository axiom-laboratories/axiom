...
- [ ] **OUT-01**: Node captures stdout and stderr for every job execution
- [ ] **OUT-02**: Exit code is recorded per execution
- [ ] **OUT-03**: Each run produces a separate execution record (not just latest result)
