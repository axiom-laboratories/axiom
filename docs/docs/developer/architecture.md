...
| `EXECUTION_MODE` | nodes | Optional | `auto` (default), `docker`, or `podman`. Use Docker socket mount + `docker`/`auto` for Docker-in-Docker. `direct` mode is deprecated as of v20.0. |
